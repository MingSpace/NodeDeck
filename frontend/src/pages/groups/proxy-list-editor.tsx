      ...
      <div className="flex items-center justify-between text-[11px] text-muted-foreground px-0.5 pt-1">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* @user_flow: 候选区底部的「全部解锁」按钮只对当前搜索可见的节点生效;
              当大量节点跨多个机场、被搜索框收窄时,那个按钮帮不上忙。
              这里提供一个无视过滤的「清空」入口,一键删空 g.proxies。
        ...
        {candidateNodes.length === 0 ? (
          <EmptyHint>
            {!hasAnyProvider
              ...
              : "当前 selector 未匹配到任何节点 — 可能机场未启用 / 尚未拉到节点 / 被 from_providers·include_region·exclude_type·regex 全部过滤掉。可点右上角 ⟳ 刷新节点池"}
          </EmptyHint>
