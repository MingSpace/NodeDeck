...
describe("parseProxyUri", () => {
  ...
  it("parses Trojan URI with sni", () => {
    const uri =
      "trojan://81863880-B813-2F0F-0007-548715CAAC97@gzdata1.233netbest.com:11102?sni=m.ctrip.com&allowInsecure=1#%F0%9F%87%AD%F0%9F%87%B0HK";
    const node = parseProxyUri(uri);
    expect(node).toMatchObject({
      type: "trojan",
      server: "gzdata1.233netbest.com",
      port: 11102,
      password: "81863880-B813-2F0F-0007-548715CAAC97",
      sni: "m.ctrip.com",
